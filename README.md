# MindMate — Offline AI Mental Health Companion App


**Explore, Experience, and Evaluate the Future of On-Device Generative AI **

The MindMate is an experimental app that puts the power of cutting-edge Generative AI models directly into your hands which is a modified version of Googles AI-edge gallery, running entirely on your Android *(available now)* and iOS *(coming soon)* devices. Dive into a world of creative and practical AI use cases, all running locally, without needing an internet connection once the model is loaded. Experiment with different models, chat, ask questions with images and audio clip, explore prompts, and more!
...
This is an **experimental Beta release**. We welcome your feedback!
